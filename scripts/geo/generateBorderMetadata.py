...
ENTITY_RULES = {
    ...
    "Tibetan Empire":   {"name_local": "བོད", "name_en": "Tibetan Empire", "palette": "EastAsia"},
    "Tibetans":         {"name_local": "བོད", "name_en": "Tibetans", "palette": "EastAsia"},
    "Mongolia":         {"name_local": "Монгол Улс", "name_en": "Mongolia", "palette": "EastAsia"},
    "Mongol Empire":    {"name_local": "Монгол Улс", "name_en": "Mongol Empire", "palette": "EastAsia"},
    "Mongols":          {"name_local": "Монгол", "name_en": "Mongols", "palette": "EastAsia"},
    # [cl] 고대 중국 왕조 (HB)
    ...
    "Liao":             {"name_local": "遼", "name_en": "Liao Dynasty", "palette": "EastAsia"},
    "Jin Empire":       {"name_local": "金", "name_en": "Jin Dynasty", "palette": "EastAsia"},
    "Xixia":            {"name_local": "西夏", "name_en": "Western Xia", "palette": "EastAsia"},
    ...
    "Yuezhi":           {"name_local": "月氏", "name_en": "Yuezhi", "palette": "EastAsia"},
    "Yueban":           {"name_local": "悅般", "name_en": "Yueban", "palette": "EastAsia"},
    "Xiongnu":          {"name_local": "匈奴", "name_en": "Xiongnu", "palette": "EastAsia"},
    "Southern Xiongnu":  {"name_local": "南匈奴", "name_en": "Southern Xiongnu", "palette": "EastAsia"},
    ...
    "Srivijaya Empire":     {"name_local": "Srivijaya", "name_en": "Srivijaya", "palette": "SoutheastAsia"},
    "Mataram":              {"name_local": "Mataram", "name_en": "Mataram", "palette": "SoutheastAsia"},
    ...
    "Aceh":                 {"name_local": "Aceh", "name_en": "Aceh", "palette": "SoutheastAsia"},
    "Malacca":              {"name_local": "Melaka", "name_en": "Malacca", "palette": "SoutheastAsia"},
    ...
    "Malaysian Islamic states": {"name_local": "Malaysia", "name_en": "Malay Islamic States", "palette": "SoutheastAsia"},
    "Brunei":               {"name_local": "Brunei", "name_en": "Brunei", "palette": "SoutheastAsia"},
    "Minang":               {"name_local": "Minangkabau", "name_en": "Minangkabau", "palette": "SoutheastAsia"},
    "East Java":            {"name_local": "Jawa Timur", "name_en": "East Java", "palette": "SoutheastAsia"},
    ...
    # [cl] 고대 중동/이슬람
    "Achaemenid Empire": {"name_local": "هخامنشیان", "name_en": "Achaemenid Empire", "palette": "Islamic"},
    "Parthia":           {"name_local": "اشکانیان", "name_en": "Parthia", "palette": "Islamic"},
    "Parthian Empire":   {"name_local": "اشکانیان", "name_en": "Parthian Empire", "palette": "Islamic"},
    "Sassanid Empire":   {"name_local": "ساسانیان", "name_en": "Sassanid Empire", "palette": "Islamic"},
    "Sassanian Empire":  {"name_local": "ساسانیان", "name_en": "Sassanid Empire", "palette": "Islamic"},
    "Seleucid Kingdom":  {"name_local": "سلوکیان", "name_en": "Seleucid Kingdom", "palette": "Islamic"},
    "Safavid Empire":    {"name_local": "صفویان", "name_en": "Safavid Empire", "palette": "Islamic"},
    "Timurid Empire":    {"name_local": "تیموریان", "name_en": "Timurid Empire", "palette": "Islamic"},
    "Timurid Emirates":  {"name_local": "تیموریان", "name_en": "Timurid Emirates", "palette": "Islamic"},
    "Abbasid Caliphate": {"name_local": "خلافة عباسية", "name_en": "Abbasid Caliphate", "palette": "Islamic"},
    "Umayyad Caliphate": {"name_local": "خلافة أموية", "name_en": "Umayyad Caliphate", "palette": "Islamic"},
    "Fatimid Caliphate": {"name_local": "خلافة فاطمية", "name_en": "Fatimid Caliphate", "palette": "Islamic"},
    "Seljuk Caliphate":  {"name_local": "سلجوقیان", "name_en": "Seljuk Empire", "palette": "Islamic"},
    "Seljuk Empire":     {"name_local": "سلجوقیان", "name_en": "Seljuk Empire", "palette": "Islamic"},
    "Ayyubid Caliphate": {"name_local": "أيوبيون", "name_en": "Ayyubid Caliphate", "palette": "Islamic"},
    "Mamluke Sultanate": {"name_local": "مماليك", "name_en": "Mamluk Sultanate", "palette": "Islamic"},
    "Caliphate of Córdoba": {"name_local": "خلافة قرطبة", "name_en": "Caliphate of Cordoba", "palette": "Islamic"},
    "Emirate of Córdoba": {"name_local": "إمارة قرطبة", "name_en": "Emirate of Cordoba", "palette": "Islamic"},
    "Almohad Caliphate": {"name_local": "الموحدون", "name_en": "Almohad Caliphate", "palette": "Islamic"},
    "Almoravid dynasty": {"name_local": "المرابطون", "name_en": "Almoravid Dynasty", "palette": "Islamic"},
    "Hafsid Caliphate":  {"name_local": "حفصيون", "name_en": "Hafsid Caliphate", "palette": "Islamic"},
    "Idrisid Caliphate": {"name_local": "أدارسة", "name_en": "Idrisid Caliphate", "palette": "Islamic"},
    "Wattasid Caliphate": {"name_local": "وطاسيون", "name_en": "Wattasid Caliphate", "palette": "Islamic"},
    "Zayyanid Caliphate": {"name_local": "زيانيون", "name_en": "Zayyanid Caliphate", "palette": "Islamic"},
    "Golden Horde":      {"name_local": "Золотая Орда", "name_en": "Golden Horde", "palette": "Islamic"},
    "Crimean Khanate":   {"name_local": "Kırım Hanlığı", "name_en": "Crimean Khanate", "palette": "Islamic"},
    "Chagatai Khanate":  {"name_local": "چغتای", "name_en": "Chagatai Khanate", "palette": "Islamic"},
    "Kara Khitai Khaganate": {"name_local": "西遼", "name_en": "Kara Khitai", "palette": "Islamic"},
    "Oirat Confederation": {"name_local": "Ойрат", "name_en": "Oirat Confederation", "palette": "EastAsia"},
    "Ghaznavid Emirate": {"name_local": "غزنویان", "name_en": "Ghaznavid Emirate", "palette": "Islamic"},
    # 고대 중동 (성서/고대)
    "Assyria":           {"name_local": "آشور", "name_en": "Assyria", "palette": "Islamic"},
    "Babylonia":         {"name_local": "بابل", "name_en": "Babylonia", "palette": "Islamic"},
    "Elam":              {"name_local": "عیلام", "name_en": "Elam", "palette": "Islamic"},
    "Ur":                {"name_local": "أور", "name_en": "Ur", "palette": "Islamic"},
    "Urartu":            {"name_local": "אורארטו", "name_en": "Urartu", "palette": "Islamic"},
    "Hittites":          {"name_local": "ḪAT-TI", "name_en": "Hittites", "palette": "Islamic"},
    "Meroe":             {"name_local": "Meroë", "name_en": "Meroe", "palette": "Africa"},
    "Kush":              {"name_local": "Kush", "name_en": "Kush", "palette": "Africa"},
    "Kerma":             {"name_local": "Kerma", "name_en": "Kerma", "palette": "Africa"},
    "Axum":              {"name_local": "አክሱም", "name_en": "Axum", "palette": "Africa"},
    "Nabatean Kingdom":  {"name_local": "النبطية", "name_en": "Nabataean Kingdom", "palette": "Islamic"},
    "Ptolemaic Kingdom": {"name_local": "بطلمي", "name_en": "Ptolemaic Kingdom", "palette": "Islamic"},
    "Kingdom of David and Solomon": {"name_local": "ישראל", "name_en": "Kingdom of Israel", "palette": "Islamic"},
    "Hadramaut":         {"name_local": "حضرموت", "name_en": "Hadramaut", "palette": "Islamic"},
    "Saba":              {"name_local": "سبأ", "name_en": "Saba", "palette": "Islamic"},
    "Himyarite Kingdom": {"name_local": "حمير", "name_en": "Himyarite Kingdom", "palette": "Islamic"},
    "Scythians":         {"name_local": "Σκύθαι", "name_en": "Scythians", "palette": "Islamic"},
    ...
    "Hunnic Empire":     {"name_local": "Hún", "name_en": "Hunnic Empire", "palette": "EastAsia"},
    "Sasanian Empire":   {"name_local": "ساسانیان", "name_en": "Sasanian Empire", "palette": "Islamic"},
    ...
    "Carthaginian Empire": {"name_local": "Carthago", "name_en": "Carthage", "palette": "Africa"},
    "Greek city-states": {"name_local": "Ελληνικές πόλεις", "name_en": "Greek City-States", "palette": "Nordic"},
    "Greek colonies":    {"name_local": "Ελληνικές αποικίες", "name_en": "Greek Colonies", "palette": "Nordic"},
    "Empire of Alexander": {"name_local": "Αλέξανδρος", "name_en": "Empire of Alexander", "palette": "Nordic"},
    # [cl] 중세 유럽 국가
    ...
    "Bulgar Khanate":    {"name_local": "България", "name_en": "Bulgarian Khanate", "palette": "Nordic"},
    "Bulgars":           {"name_local": "България", "name_en": "Bulgars", "palette": "Nordic"},
    "Avars":             {"name_local": "Avars", "name_en": "Avars", "palette": "Nordic"},
    "Magyars":           {"name_local": "Magyarok", "name_en": "Magyars", "palette": "Nordic"},
    "Khazars":           {"name_local": "Хазар", "name_en": "Khazars", "palette": "Islamic"},
    ...
    "Polish-Lithuanian Commonwealth": {"name_local": "Rzeczpospolita", "name_en": "Polish-Lithuanian Commonwealth", "palette": "Nordic"},
    "Poland-Lithuania":  {"name_local": "Rzeczpospolita", "name_en": "Poland-Lithuania", "palette": "Nordic"},
    ...
    "Kingdom of Hungary": {"name_local": "Magyarország", "name_en": "Kingdom of Hungary", "palette": "Nordic"},
    "Kingdom of Ireland": {"name_local": "Éire", "name_en": "Kingdom of Ireland", "palette": "British"},
    "Croatian kingdom":  {"name_local": "Hrvatska", "name_en": "Croatian Kingdom", "palette": "Nordic"},
    ...
    # [cl] 아프리카 고대/중세 왕국
    "Songhai":              {"name_local": "Songhai", "name_en": "Songhai", "palette": "Africa"},
    "Empire of Ghana":      {"name_local": "Ghana", "name_en": "Ghana Empire", "palette": "Africa"},
    "Great Zimbabwe":       {"name_local": "Zimbabwe", "name_en": "Great Zimbabwe", "palette": "Africa"},
    "Kanem":                {"name_local": "Kanem", "name_en": "Kanem", "palette": "Africa"},
    "Bornu-Kanem":          {"name_local": "Bornu-Kanem", "name_en": "Bornu-Kanem", "palette": "Africa"},
    "Hausa States":         {"name_local": "Hausa", "name_en": "Hausa States", "palette": "Africa"},
    "Bantou":               {"name_local": "Bantu", "name_en": "Bantu", "palette": "Africa"},
    "Alwa":                 {"name_local": "Alwa", "name_en": "Alwa", "palette": "Africa"},
    "Makkura":              {"name_local": "Makuria", "name_en": "Makuria", "palette": "Africa"},
    "Expansionist Kingdom of Merina": {"name_local": "Merina", "name_en": "Kingdom of Merina", "palette": "Africa"},
    "Khoiasan":             {"name_local": "Khoisan", "name_en": "Khoisan", "palette": "Africa"},
    "Guanches":             {"name_local": "Guanche", "name_en": "Guanches", "palette": "Africa"},
